  ...
  return (
    <section className="py-24 bg-white">
      <div className="container mx-auto px-8 max-w-7xl">
        ...
        <h2 className="text-5xl md:text-7xl font-bold text-brand-dark mb-12 tracking-tighter">Testimonials</h2>
            ...
            <div key={i} className="bg-brand-gray p-8 rounded-2xl relative flex flex-col justify-between min-h-[350px]" data-aos="fade-up" data-aos-delay={i * 100}>
              ...
              <div>
                ...
                <div className="flex items-center space-x-1 mb-8">
                  ...
                  <span className="font-semibold text-brand-dark ml-2">{t.rating}</span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center mt-auto">
                <div className="flex items-center space-x-3">
                  <div className={`w-10 h-10 rounded-full ${t.imgColor} text-white flex items-center justify-center font-semibold text-lg`}>
                    {t.name.charAt(0)}
                  </div>
                  <div>
